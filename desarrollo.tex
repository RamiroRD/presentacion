...
\begin{frame}
	...
	\begin{itemize}
		 \item El sistema se conecta una red WiFi preexistente.
		 \item El usuario accede a un panel mediante HTTPS y se autentica
		 \item El usuario ingresa el anuncio a mostrar
